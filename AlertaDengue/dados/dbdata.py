...
class RegionalParameters:
    def __init__(
        ...
        cls.t_parameters = con.table('parameters', database, 'Dengue_global')
        cls.t_municipio = con.table('Municipio', database, 'Dengue_global')
        cls.t_estado = con.table('estado', database, 'Dengue_global')
        cls.t_regional = con.table('regional', database, 'Dengue_global')

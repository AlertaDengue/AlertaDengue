...
pytestmark = pytest.mark.usefixtures("hist_uf_dengue_table")


def test_data_hist_uf_orders_desc() -> None:
...
def test_data_hist_uf_is_cached() -> None:
...
def test_data_hist_uf_empty_keeps_columns() -> None:

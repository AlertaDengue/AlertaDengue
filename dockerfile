...
RUN /home/dengue/AlertaDengue/AlertaDengue/environment.yml /tmp/environment.yml
RUN /home/dengue/AlertaDengue/AlertaDengue/requirements-dev.txt /tmp/requirements-dev.txt
